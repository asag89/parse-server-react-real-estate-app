...
const HouseDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchHouse = async () => {
      let parseQuery = new Parse.Query("Houses");
      const { attributes, id, createdAt, updatedAt } = await parseQuery.get(
        params.houseId
      );

      setHouse({ ...attributes, id, createdAt, updatedAt });
    };
    fetchHouse();
    setLoading(false)
      ...
      <HouseDetailsWrapper>
        <HouseDetailsTop>
          ...
          <HouseDetailShareLink
            ...
            title={shareLinkCopied ? "Link Copied" : "Copy the Link"}
            onClick={() => {
        ...
        <HouseDetailsInfo>
          <HouseDetailsFor to={`/for-${house?.forType}`}>
            For {house?.forType}
          </HouseDetailsFor>
          <HouseDetailsType to={`/type/${house?.type}`}>
            {house?.type}
          </HouseDetailsType>
          {house?.offer && (
